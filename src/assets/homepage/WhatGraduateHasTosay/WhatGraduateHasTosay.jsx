...
const WhatGraduateHasTosay = () => {
  ...
  return (
    ...
    <div className='container mx-auto mt-[48px] md:mt-[80px] text-text-black px-[20px] md:px-0'>
        ...
        <div className='flex flex-col md:flex-row gap-[40px] md:gap-[132px] relative '>
            <div className={`w-full md:w-1/2 ${width < 768?"order-2":"order-1"} sticky top-20 self-start `}>       
