...
const Hero = () => {
  return (
    <div className=''>
        <div className="container mx-auto px-[20px] md:px-0 mt-[42px] flex flex-col gap-[30.1px] md:gap-[55px] md:flex-row md:min-h-[75vh]">
        <div className='flex gap-[30px] flex-col md:w-1/2'>
            <h1 className="font-MulishRegular font-bold text-[32px] leading-[50px] text-white md:hidden">
            Transition into tech in 12 weeks?
            </h1>
            <h1 className="font-MulishRegular font-bold text-[32px] leading-[50px] text-white hidden md:block">
            ...
            <button className='text-white md:text-purple md:bg-white w-fit rounded-lg font-[500] text-[14.32px] leading-[21.34px] flex gap-[10.69px] font-DmSansRegular items-center py-[17.04px] px-[16.95px] '>
                Get Started <div className='md:hidden'><img src={forward} alt="" /></div>
                <div className='hidden md:block'><img src={icon} alt="" /></div>
            </button>
            <div className='flex flex-col gap-[16.75px] md:flex-row'>
                <div>
        ...
        <div className='w-[350px] md:w-1/2 h-[373px] md:h-[initial] object-center'>
            <img src={herobg} alt=""  className='w-full block md:hidden'/>
            <img src={herobgdesk} alt="" className='hidden md:block w-full h-full md:h-[initial]'/>
        </div>
        </div>
    </div>
  )
