...
const EMpowering = () => {
  return (
    <div>
        <div className="container mx-auto px-[20px] md:px-0 flex gap-[52px] mt-[68px] h-[471px] ">
            <div className='md:w-[50%] '>
        <HompagesHeader text={'Empowering Digital Transformation in the Modern Era'} left={true} after={'purple'}/>
        <p className='font-[400] text-[18px] leading-[50px] font-DmSansRegular md:mt-[18px] '>
